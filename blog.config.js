...
const BLOG = {
  ...
  // https://buttery-bunny-ae5.notion.site/4acc944e38e14f7c983f79f9b752e80a?v=886257ab4a7b4c64a4997ffc60f6a6b8&pvs=4
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '4acc944e38e14f7c983f79f9b752e80a',
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Anonymity', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '一个普通的干饭人🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.myls.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'my_ls@outlook.com', // 邮箱地址 例如mail@tangly1024.com
  CONTACT_WEIBO: process.env.NEXT_PUBLIC_CONTACT_WEIBO || '', // 你的微博个人主页
  CONTACT_TWITTER: process.env.NEXT_PUBLIC_CONTACT_TWITTER || '', // 你的twitter个人主页
  CONTACT_GITHUB: process.env.NEXT_PUBLIC_CONTACT_GITHUB || 'https://github.com/AnonymityL', // 你的github个人主页 例如 https://github.com/tangly1024
  ...
  // ----> 站点统计
  SPEED_INSIGHTS_VERCEL: process.env.NEXT_PUBLIC_SPEED_INSIGHTS_VERCEL || true,
  ...
  ANALYTICS_BAIDU_ID: process.env.NEXT_PUBLIC_ANALYTICS_BAIDU_ID || 'd4a8e2a21cde16844b8adfb0497b2235', // e.g 只需要填写百度统计的id，[baidu_id] -> https://hm.baidu.com/hm.js?[baidu_id]
  ANALYTICS_CNZZ_ID: process.env.NEXT_PUBLIC_ANALYTICS_CNZZ_ID || '', // 只需要填写站长统计的id, [cnzz_id] -> https://s9.cnzz.com/z_stat.php?id=[cnzz_id]&web_id=[cnzz_id]
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-KWQWPLB43Q', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
